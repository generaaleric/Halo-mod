...
namespace halo.Items.weapons
{
	public class EnergySword : ModItem
	{
		...
		{
			Tooltip.SetDefault("used by the elites and perfect for melting your enemies");
		}

		public override void SetDefaults()
		{
			item.damage = 95;           //The damage of your weapon
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(mod, "TriniumBar", 28);
			recipe.AddTile(134);
